...
TerminalList.prototype.getMatches = function(str) {
  ...
  return Object.assign(Object.create(TerminalMatchList), {items: matches});
};
...
function defaultTokenFactory(terminalMatch, fileInfo) {
  return Object.assign(Object.create(Token), {terminalMatch, fileInfo, value: terminalMatch.value});
}
